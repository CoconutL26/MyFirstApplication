...
public class ShopDownLoaderTest {
    ...
    public void download() {
        ShopDownLoader httpDataLoader=new ShopDownLoader();
        String fileContent=httpDataLoader.download("http://file.nidama.net/class/mobile_develop/data/bookstore2023.json");
        assertTrue(fileContent.contains("\"name\": \"暨珠海\","));
    ...
    public void parseJsonObjects() {
        ...
        assertEquals("暨珠海",locations.get(0).getName());
